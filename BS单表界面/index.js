...
function index__dg_index_eb_colcortest11_connection(target,orgSelection,newSelection) {
    ...
    //获取需要联动的下级控件
    //e.g.⬇️
    var subDG = GUI.Doms._dg_index_eb_colcortest11;
    var value = newSelection[""];
    var filter = "'"+value +"'";
...
//function index__dg_index_eb_colcortest11_beforeAdd(target,newData) {
//}
...
function index_init(parentDom){
    ...
    //假设有一个控件放在className为class1的div下面
        _div_class = _this.querySelector("._dg_index_eb_colcortest11").children[0];
    //必须在这个地方调用
    ...
    _this._dg_index_eb_colcortest11 = _div_class;
    GUI.Doms._dg_index_eb_colcortest11 = _div_class;
    _div_class = new Object();
    //写Connection相关的events
    _this._dg_index_eb_colcortest11.addOnSelectionChangedListener(index__dg_index_eb_colcortest11_connection);


    //写特殊events
    //_this._dg_index_eb_colcortest11.addOnBeforeAddListener(index__dg_index_eb_colcortest11_beforeAdd);
