...
%>
<div id = "<%=ui%>" class="colcoradd orui_popup_model" infos='<%=baseInfos%>' queryPlan='<%=baseQueryPlan%>'>
    <div id="<%=ui%>_hidden_div">
    </div>
    <div class="orui_popup_title">颜色添加</div>
    ...
    <div class="orui_popup_center">
        <div class="orui_frame_top" style="height:100%;">
            ...
            <div class="orui_frame_top_content" style="height:100%">
                <div class="orui_frame_top_content_left _pg_coloradd_eb_colcortest11" style="width: 100%; height: 100%; ">
                    <div _entityBias="eb_colcortest11"
                         ...
                         _infos='<%=OperationHelpers.getEntitiesByEntityBias("testcolor", "colcoradd", "eb_colcortest11")%>'
                    ></div>
                </div>
