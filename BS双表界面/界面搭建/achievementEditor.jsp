...
<%
    ...
    String ui = "achievementEditor";

    String baseInfos = "[]";//OperationHelpers.getEntities("studentTest3",ui);
    String baseQueryPlan = "[]";
%>
<div id = "<%=ui%>" class="achievementEditor orui_popup_model" infos='<%=baseInfos%>' queryPlan='<%=baseQueryPlan%>'>
    <div id="<%=ui%>_hidden_div">
    </div>
    <div class="orui_popup_title">成绩编辑</div>
    ...
    <div class="orui_popup_center">
        <div class="orui_frame_top" style="height:100%;">
            ...
            <div class="orui_frame_top_content" style="height:100%">
                <div class="orui_frame_top_content_left _pg_achievementEditor_eb_achievementTest3" style="width: 100%; height: 100%; ">
                    <div _entityBias="eb_achievementTest3"
                         _width="100%"
                         _height="100%"
                         _tabName=""
                         _blockName=""
                         ...
                         _infos='<%=OperationHelpers.getEntitiesByEntityBias("studentTest3", "achievementEditor", "eb_achievementTest3")%>'
                    ></div>
                </div>
