...
<%
    ...
    String ui = "achievementAdd";

    String baseInfos = "[]";//OperationHelpers.getEntities("studentTest3",ui);
    String baseQueryPlan = "[]";
%>
<div id = "<%=ui%>" class="achievementAdd orui_popup_model" infos='<%=baseInfos%>' queryPlan='<%=baseQueryPlan%>'>
    <div id="<%=ui%>_hidden_div">
    </div>
    <div class="orui_popup_title">成绩增加</div>
    ...
    <div class="orui_popup_center">
        <div class="orui_frame_top" style="height:100%;">
            ...
            <div class="orui_frame_top_content" style="height:100%">
                <div class="orui_frame_top_content_left _pg_achievementAdd_eb_achievementTest3" style="width: 100%; height: 100%; ">
                    <div _entityBias="eb_achievementTest3"
                         ...
                         _infos='<%=OperationHelpers.getEntitiesByEntityBias("studentTest3", "achievementAdd", "eb_achievementTest3")%>'
                    ></div>
                </div>
